...
import distribuidos.sistemas.trabalho.clienteSoap.CidadeSOAP;
...
public class TelaListarContato extends javax.swing.JFrame {
    ...
    private List<CidadeSOAP> cidades;

    public List<CidadeSOAP> getCidades() {
        return cidades;
    }

    public void setCidades(List<CidadeSOAP> cidades) {
        this.cidades = cidades;
        comboCidade.removeAllItems();
        for (CidadeSOAP c : cidades) {
    ...
    private void comboCidadePopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_comboCidadePopupMenuWillBecomeInvisible
        ...
        CidadeSOAP cidade= (CidadeSOAP) comboCidade.getSelectedItem();
